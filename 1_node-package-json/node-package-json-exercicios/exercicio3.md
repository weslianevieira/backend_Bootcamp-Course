...
- exemplos de fluxo:
    - ```node pedra-papel-tesoura.js pedra```
        ...
        - aparece no console: `Você escolheu ${escolhaJogador} e o computador escolheu ${escolhaComputador}. Você ganhou!`
    ...
    - ```node pedra-papel-tesoura.js tesoura```
        ...
        - aparece no console: `Você escolheu ${escolhaJogador} e o computador escolheu ${escolhaComputador}. Empate!`
